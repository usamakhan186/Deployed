...
const SafePurchaseSection = () => {
  ...
  <section className="relative">
    ...
    <div className="md:hidden absolute top-0 left-0 w-full h-[70%] bg-red-500" />
    ...
    <div className="relative py-10 px-6">
      <div className="text-center relative">
        <h2 className="text-2xl font-semibold md:text-gray-800 text-white md:text-center">
          You're not risking anything when you buy a vehicle <br /> on Store name
        </h2>
      </div>
