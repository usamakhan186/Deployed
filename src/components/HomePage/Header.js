...
{/* Mobile View */}
{/* Mobile View */}
<div className="md:hidden relative w-full bg-red-500">
  <div
  ...
  >
    ...
    <div className="absolute inset-0 bg-gradient-to-t from-red-500 via-red-500/70 to-transparent" 
         style={{ 
           background: 'linear-gradient(to top, rgb(239 68 68) 0%, rgba(239, 68, 68, 0.7) 50%, transparent 75%)'
         }} 
    />
...
<div className="hidden md:block relative w-full min-h-screen">
  <div
    className="relative flex flex-col bg-no-repeat bg-cover bg-center min-h-screen"
    style={{
      backgroundImage: `url(${car.src})`,
      backgroundSize: 'cover',
    }}
